...
var UpdateAvatarService_1 = __importDefault(require("../services/UpdateAvatarService"));
...
usersRouter.post('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, password, avatar, createUserService, user;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = request.body, name = _a.name, email = _a.email, password = _a.password, avatar = _a.avatar;
...
usersRouter.patch('/avatar', EnsureAuthenticated_1.default, upload.single('avatar'), function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var updateAvatar, id, user, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                updateAvatar = new UpdateAvatarService_1.default();
                id = request.user.id;
