...
var CreateAppointmentService = /** @class */ (function () {
    ...
    CreateAppointmentService.prototype.execute = function (_a) {
        var name = _a.name, email = _a.email, password = _a.password, avatar = _a.avatar;
        return __awaiter(this, void 0, void 0, function () {
            var usersRepository, checkIfUserAlreadyExists, hashedPassword, user;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        checkIfUserAlreadyExists = _b.sent();
