...
const UpdateAvatarService_1 = __importDefault(require("@modules/Users/services/UpdateAvatarService"));
const ResetPasswordService_1 = __importDefault(require("@modules/Users/services/ResetPasswordService"));
const SendNewPasswordByEmailService_1 = __importDefault(require("@modules/Users/services/SendNewPasswordByEmailService"));
const UpdateUserPasswordService_1 = __importDefault(require("@modules/Users/services/UpdateUserPasswordService"));
const UpdateProfileService_1 = __importDefault(require("@modules/Users/services/UpdateProfileService"));
const ShowOneUserService_1 = __importDefault(require("@modules/Users/services/ShowOneUserService"));
const DeleteUserService_1 = __importDefault(require("@modules/Users/services/DeleteUserService"));
const ShowEventsAboutUserInterestService_1 = __importDefault(require("@modules/Users/services/ShowEventsAboutUserInterestService"));
const ShowEventsWithEventTypeInteresOfUser_1 = __importDefault(require("@modules/Users/services/ShowEventsWithEventTypeInteresOfUser"));
const multer_2 = __importDefault(require("../../../../../config/multer"));
const EnsureAuthenticated_1 = __importDefault(require("../middlewares/EnsureAuthenticated"));
const typeorm_2 = __importDefault(require("../../../../../shared/infra/typeorm"));
const UsersRepository_1 = __importDefault(require("../../typeorm/repositories/UsersRepository"));
const usersRouter = express_1.Router();
usersRouter.post('/', async (request, response) => {
    try {
        const { name, email, password, avatar, musicinterest1_id, musicinterest2_id, musicinterest3_id, love, state, city, birthday, cpf, cellphone, sex, } = request.body;
        const createUserService = new CreateUserService_1.default(await typeorm_2.default);
...
usersRouter.post('/resetPassword', async (request, response) => {
    try {
        ...
        const resetPasswordService = new ResetPasswordService_1.default(await typeorm_2.default);
...
usersRouter.post('/updatePassword', EnsureAuthenticated_1.default, async (request, response) => {
    try {
        ...
        const updateUserPasswordService = new UpdateUserPasswordService_1.default(await typeorm_2.default);
...
usersRouter.get('/:id', async (request, response) => {
    try {
        ...
        const showOneUserService = new ShowOneUserService_1.default(await typeorm_2.default);
...
usersRouter.post('/uploadAvatar', EnsureAuthenticated_1.default, multer_1.default(multer_2.default).single('avatar'), async (request, response) => {
    try {
        ...
        const { id } = request.user;
        const updateAvatarService = new UpdateAvatarService_1.default(await typeorm_2.default);
...
usersRouter.patch('/updateUserProfile', EnsureAuthenticated_1.default, async (request, response) => {
    try {
        ...
        const updateProfileService = new UpdateProfileService_1.default(await typeorm_2.default);
...
usersRouter.delete('/deleteUser/:id', async (request, response) => {
    try {
        const deleteUserService = new DeleteUserService_1.default(await typeorm_2.default);
        const { id } = request.params;
...
usersRouter.post('/interests', EnsureAuthenticated_1.default, async (request, response) => {
    try {
        const { id } = request.user;
        const showEventsAboutUserInterestService = new ShowEventsAboutUserInterestService_1.default(await typeorm_2.default);
...
usersRouter.post('/eventTypes', async (request, response) => {
    try {
        ...
        const showEventsWithEventTypeInteresOfUser = new ShowEventsWithEventTypeInteresOfUser_1.default(await typeorm_2.default);
