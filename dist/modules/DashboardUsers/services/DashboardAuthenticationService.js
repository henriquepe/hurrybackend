...
let DashboardAuthenticationService = class DashboardAuthenticationService {
    constructor(connection) {
        this.connection = connection;
        this.dashboardUsersRepository = this.connection.getCustomRepository(DashboardUsersRepository_1.default);
    }
...
DashboardAuthenticationService = __decorate([
    typedi_1.Service(),
    __metadata("design:paramtypes", [typeorm_1.Connection])
], DashboardAuthenticationService);
exports.default = DashboardAuthenticationService;
//# sourceMappingURL=DashboardAuthenticationService.js.map